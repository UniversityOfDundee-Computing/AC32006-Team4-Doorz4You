...
function registerCustomerHandler(PDO $pdo) {
    ...
    $stmnt = $pdo->prepare("INSERT INTO `22ac3d04`.`customers` (`CustomerNo`, `FirstName`, `ContactNo`, `Email`, `Street`, `City`, `PostCode`, `Country`, `Surname`, `Password`, sessionToken) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, null);");
